...
const forgotPasswordSubtitle = document.getElementById(
...
signupFormElement.addEventListener("submit", (e) => {
  ...
  if (!name || !email || !password || !confirmPassword) {
    signupError.querySelector(".alert-message").textContent =
...
// Forgot Password - Email Form
forgotPasswordEmailForm.addEventListener("submit", (e) => {
  e.preventDefault();
  ...
  if (!user) {
    forgotPasswordError.querySelector(".alert-message").textContent =
